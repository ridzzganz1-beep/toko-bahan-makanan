...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="rounded-2xl glass border border-white/10 p-8 shadow-xl">
        ...
        <div class="mb-8">
            ...
            <table class="w-full">
                ...
                <thead class="border-b-2 border-white/10">
                    <tr>
                        <th class="text-left text-slate-300 font-semibold text-sm py-3">
                            ITEM
                        </th>

                        <th class="text-right text-slate-300 font-semibold text-sm py-3">
                            HARGA
                        </th>
        ...
        <div class="text-center py-6 border-t-2 border-dashed border-white/20">
            ...
            <p class="text-slate-500 text-xs">
                Simpan struk ini untuk referensi
            </p>
    ...
    <div class="flex gap-4 flex-col sm:flex-row">
        ...
        <a href="javascript:window.print()"
           class="flex-1 flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-indigo-500 to-sky-500 text-white font-semibold hover:shadow-lg hover:scale-105 transition-all">
        ...
        <a href="{{ route('transaksi.create') }}"
           class="flex-1 flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-slate-800/50 border border-white/10 text-slate-300 hover:bg-slate-800 font-semibold transition-all">
